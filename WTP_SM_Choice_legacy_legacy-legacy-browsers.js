/************************************ 
 * Wtp_Sm_Choice_Legacy_Legacy Test *
 ************************************/


// store info about the experiment session:
let expName = 'WTP_SM_Choice_legacy_legacy';  // from the Builder filename that created this script
let expInfo = {
    'participant': '',
    'session': '001',
};
...
async function updateInfo() {
  ...
  psychoJS.setRedirectUrls(('https://adelphiderner.qualtrics.com/jfe/form/SV_2bF7lXuTQzoEIGq?PROLIFIC_PID=' + expInfo['participant']), '');
