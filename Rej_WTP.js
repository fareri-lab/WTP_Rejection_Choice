...
function ExperiencecomputerchoiceRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ExperiencecomputerchoiceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Experience_computer_choiceRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Experience_computer_choiceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SchoiceRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SchoiceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ExperienceselfchoiceRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ExperienceselfchoiceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
